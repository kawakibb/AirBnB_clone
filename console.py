...
class HBNBCommand(cmd.Cmd):
    ...
    def do_update(self, arg):
        """
        This command allows you to update a class instance's attributes by specifying
        the class name, instance ID, attribute name, and attribute value, or by providing
        """
        argl = parse(arg)
        objdict = storage.all()
